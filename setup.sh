...
nginx --version || apt install nginx -y
docker --version || DEBIAN_FRONTEND=noninteractive apt-get install -y docker-ce docker-ce-cli containerd.io
# apt install docker.io -y
# apt install docker-compose -y

subdomain="neoteric.naija.ee"
